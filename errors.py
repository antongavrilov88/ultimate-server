...
ERROR_TYPES_TO_ISSUE_CODES_MAPPING = {
    UltimateServerErrorType.BACKEND_TIMEOUT_ERROR: [1000, 1001],
    UltimateServerErrorType.GENERIC_DB_ENGINE_ERROR: [1002],
    UltimateServerErrorType.COLUMN_DOES_NOT_EXIST_ERROR: [1003, 1004],
    UltimateServerErrorType.TABLE_DOES_NOT_EXIST_ERROR: [1003, 1005],
    UltimateServerErrorType.SCHEMA_DOES_NOT_EXIST_ERROR: [1003, 1016],
    UltimateServerErrorType.MISSING_TEMPLATE_PARAMS_ERROR: [1006],
    UltimateServerErrorType.INVALID_TEMPLATE_PARAMS_ERROR: [1028],
    UltimateServerErrorType.RESULTS_BACKEND_NOT_CONFIGURED_ERROR: [1021],
    UltimateServerErrorType.DML_NOT_ALLOWED_ERROR: [1022],
    UltimateServerErrorType.CONNECTION_INVALID_HOSTNAME_ERROR: [1007],
    UltimateServerErrorType.CONNECTION_PORT_CLOSED_ERROR: [1008],
    UltimateServerErrorType.CONNECTION_HOST_DOWN_ERROR: [1009],
    UltimateServerErrorType.GENERIC_COMMAND_ERROR: [1010],
    UltimateServerErrorType.GENERIC_BACKEND_ERROR: [1011],
    UltimateServerErrorType.CONNECTION_INVALID_USERNAME_ERROR: [1012],
    UltimateServerErrorType.CONNECTION_INVALID_PASSWORD_ERROR: [1013],
    UltimateServerErrorType.CONNECTION_ACCESS_DENIED_ERROR: [1014, 1015],
    UltimateServerErrorType.CONNECTION_UNKNOWN_DATABASE_ERROR: [1015],
    UltimateServerErrorType.CONNECTION_DATABASE_PERMISSIONS_ERROR: [1017],
    UltimateServerErrorType.CONNECTION_MISSING_PARAMETERS_ERROR: [1018],
    UltimateServerErrorType.INVALID_PAYLOAD_FORMAT_ERROR: [1019],
    UltimateServerErrorType.INVALID_PAYLOAD_SCHEMA_ERROR: [1020],
    UltimateServerErrorType.INVALID_CTAS_QUERY_ERROR: [1023],
    UltimateServerErrorType.INVALID_CVAS_QUERY_ERROR: [1024, 1025],
    UltimateServerErrorType.SQLLAB_TIMEOUT_ERROR: [1026, 1027],
    UltimateServerErrorType.OBJECT_DOES_NOT_EXIST_ERROR: [1029],
    UltimateServerErrorType.SYNTAX_ERROR: [1030],
    UltimateServerErrorType.RESULTS_BACKEND_ERROR: [1031, 1032, 1033],
    UltimateServerErrorType.CONNECTION_INVALID_PORT_ERROR: [1034],
    UltimateServerErrorType.ASYNC_WORKERS_ERROR: [1035],
    UltimateServerErrorType.DATABASE_NOT_FOUND_ERROR: [1011, 1036],
    UltimateServerErrorType.CONNECTION_DATABASE_TIMEOUT: [1001, 1009],
}
